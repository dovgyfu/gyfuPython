...
docDir = r'w:\greenway\MHNI_Clinical_Docs'
...
docIndex = df[['MRN', 'DocID', 'DocDate', 'DocType', 'File']]
docIndex['MRN'] = docIndex.MRN.str[1:]
docIndex['DocID'] = docIndex.DocID.str[1:]

docIndex.to_csv(r'y:\MHNI_Data\Document_index.csv', index=False)
