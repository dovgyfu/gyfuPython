...
doneDocList = doneDocList.reset_index()
doneDocList.drop(['index', 'ExtID', 'ExtDate', 'extTime', 'ftype', 'dup'],inplace=True,axis=1)
doneDocList.to_csv(dataDir + "doneDocList.csv", index=False)
#doneDocList.to_excel(dataDir + "doneDocList.xlsx", index=False)
